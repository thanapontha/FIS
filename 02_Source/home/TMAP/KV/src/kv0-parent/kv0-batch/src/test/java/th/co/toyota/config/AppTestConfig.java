 ...
 * Program History
 * 
 * Project Name	            :  st3-library-batch-template
 * Client Name				:  TMAP-EM
 * Package Name             :  th.co.toyota.config
 * Program ID 	            :  AppTestConfig.java
...
@Configuration
@PropertySource({ "classpath:properties/data-access-test.properties",
...
@ComponentScan(value = { "th.co.toyota.st3.api.util", 
						...
						"th.co.toyota.kv0.api.repository.common",
						"th.co.toyota.kv0.api.service.common",
						"th.co.toyota.kv0.batch"})

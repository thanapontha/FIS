 ...
 * Client Name				:  TDEM
 * Package Name             :  th.co.toyota.kv0.batch.main
 ...
 ********************************************************/
package th.co.toyota.kv0.batch.main;
...
import th.co.toyota.kv0.batch.common.CommonBatchUtil;
import th.co.toyota.kv0.batch.service.ExampleConvertExcelToStageService;
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (exampleConvertExcelToStage.service
				...
				result = exampleConvertExcelToStage.convertExcelToStaging(tableName, exampleConvertExcelToStage.loggerBKV02130);
			} else {
			...
			exampleConvertExcelToStage.loggerBKV02130.error(appId, CST30000Messages.ERROR_UNDEFINED_ERROR, errMsg, createBy);
		}

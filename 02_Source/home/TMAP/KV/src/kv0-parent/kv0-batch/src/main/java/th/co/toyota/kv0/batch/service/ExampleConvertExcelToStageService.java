 ...
 * Client Name				:  TDEM
 * Package Name             :  th.co.toyota.kv0.batch.service
 ...
 ********************************************************/
package th.co.toyota.kv0.batch.service;
...
import th.co.toyota.kv0.api.common.upload.CommonDataFileUploadExcelConversionDTO;
...
import th.co.toyota.kv0.api.service.common.CommonService;
import th.co.toyota.kv0.batch.repository.ExampleConvertExcelToStageRepository;
...
public class ExampleConvertExcelToStageService extends CommonDataFileUpload{
	...
	public boolean validateParameters(String[] params, int lengthParamCheck, String appId, String createBy, String fileName, String fileId) {
		...
		if (params.length != lengthParamCheck) {
			...
			logger.error(errMsg);
			loggerBKV02130.error(appId, CST30000Messages.ERROR_MESSAGE_MISSING_PARAMETER, errMsg, createBy);
			return false;
		}
	...
	public Object[] convertExcelToStaging(String tableName) throws CommonErrorException{
		try{
			...
			logger.error(errMsg);
			loggerBKV02130.error(appId, e.getMessageCode(), errMsg, createBy);
			throw e;
		}
	}
		...
		if (Strings.isNullOrEmpty(appId)) {
			try {
				...
				String errMsg = messageSource.getMessage(messageCode,
						...
						Locale.getDefault());
				logger.error(errMsg);
				loggerBKV02130.error(appId, messageCode, errMsg, createBy);
			}
		}
		return appId;
	}

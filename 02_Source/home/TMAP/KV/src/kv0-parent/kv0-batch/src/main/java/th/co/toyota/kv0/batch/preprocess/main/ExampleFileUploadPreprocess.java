 ...
 * Project Name	            :  
 * Client Name				:  TDEM
 * Package Name             :  th.co.toyota.kv0.batch.preprocess.main
 ...
 ********************************************************/
package th.co.toyota.kv0.batch.preprocess.main;
...
import th.co.toyota.kv0.api.repository.common.CommonAPIRepository;
import th.co.toyota.kv0.batch.preprocess.service.ExampleFileUploadPreprocessService;
...
public class ExampleFileUploadPreprocess implements IST31250PreProcessClass {
	...
	@Autowired
	private IST30000LoggerDb loggerBKV02130;
	...
	public static void main(String[] args) {
		...
		arg0.setModuleId(AppConstants.MODULE_ID_KV02);
		arg0.setFunctionId("BKV02130");
	...
	public int preProcessInterfaceFileData(CST31250FileReceivingCmdOptions arg0) {
		...
		try(Connection conn = commonRepository.getConnection()) {
			...
			logger.info(msg);
			loggerBKV02130.start(appId, CST30000Messages.INFO_PROCESS_START, msg, createBy);
			...
			if (result == CST30000Constants.SUCCESS) {
				msg = messageSource.getMessage(
						...
						Locale.getDefault());
				logger.info(msg);
				loggerBKV02130.end(appId, CST30000Messages.INFO_PROCESS_END_SUCCESS, msg, createBy);
				...
				msg = messageSource.getMessage(
						...
						Locale.getDefault());
				logger.error(msg);
				loggerBKV02130.endError(appId, CST30000Messages.INFO_PROCESS_END_ERROR, msg, createBy);
				...
				msg = messageSource.getMessage(
						...
						Locale.getDefault());
				logger.warn(msg);
				loggerBKV02130.endError(appId, CST30000Messages.INFO_PROCESS_END_WARNING, msg, createBy);
			}
			...
			String errMsg = messageSource
					.getMessage(CST30000Messages.ERROR_UNDEFINED_ERROR,
							...
							Locale.getDefault());
			logger.error(errMsg);
			loggerBKV02130.error(appId, CST30000Messages.ERROR_UNDEFINED_ERROR,
					errMsg, createBy);
			...
			errMsg = messageSource.getMessage(
					...
					Locale.getDefault());
			logger.error(errMsg);
			loggerBKV02130.endError(appId, CST30000Messages.INFO_PROCESS_END_ERROR, errMsg, createBy);

...
<views:style src="fis/WKV04131.css"/>
<views:script src="fis/WKV04131.js"/>
	...
	<table style="width: 100%; border: 0;">
				...
				<div id="search-result" class="overflow-hidden" style="height: 330px;">
							<div id="dataList" class="container" style="height: 310px; width:100%;border: none;" >
								<form id="result-list-form" 
								    ...
								    <spring:message code="KV0.WKV04131.Label.No" var="ColNo"/>
									<spring:message code="KV0.WKV04131.Label.UnitModel" var="ColUnitModel"/>
									<spring:message code="KV0.WKV04131.Label.UnitType" var="ColType"/>
									<spring:message code="KV0.WKV04131.Label.UnitPlant" var="ColUnitPlant"/>
		...
		<tr><td>
			<div id="save-panel" style="display:inline;zoom:1;position:relative;float: right;">
				<spring:message code="ST3.WST33060.Label.BtnSelect" var="WKV04131Select" />
				<sc2:button functionId="KV0413"  screenId="WKV04131" buttonId="WKV04131Select" 
					type="button" value="${WKV04131Select}"  style="width:80px;"
					styleClass="button" onClick="selectData();"
				/>
				<spring:message code="ST3.WST33021.Label.btnDetailClose" var="WKV04131Cancel" />
				<sc2:button functionId="KV0413"  screenId="WKV04131" buttonId="WKV04131Cancel" 
					type="button" value="${WKV04131Cancel}" 

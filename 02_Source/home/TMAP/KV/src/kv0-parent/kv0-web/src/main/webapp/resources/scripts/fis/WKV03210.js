(function($) {
	...
	$(function() {
		...
		ST3Lib.validate.disabledButtonSpecify('#WKV03210Download', true);
//		ST3Lib.validate.disabledButtonSpecify('#WKV03210Clear', true);
			...
			if($("#reportCodeSearch").val()===''){
				...
				$.ajax({
					...
					.success(function( datas ) {
						...
						ST3Lib.validate.disabledButtonSpecify('#WKV03210Download', false);
						ST3Lib.validate.disabledButtonSpecify('#WKV03210Clear', false);

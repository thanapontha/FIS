...
<views:style src="fis/WKV04240.css" />
<script>
	...
	MKV00011AERR = '<spring:message code="MKV00011AERR"></spring:message>';
	MSTD0050AERR = '<spring:message code="MSTD0050AERR"></spring:message>';

	monthlyCapacity = '<spring:message code="KV0.WKV04240.Label.MonthlyCapacity"></spring:message>';
	dailyCapacity = '<spring:message code="KV0.WKV04240.Label.DailyCapacity"></spring:message>';
	workingdays = '<spring:message code="KV0.WKV04240.Label.WorkingDays"></spring:message>';
	workingtime = '<spring:message code="KV0.WKV04240.Label.WorkingTime"></spring:message>';
	workingshift = '<spring:message code="KV0.WKV04240.Label.WorkingShift"></spring:message>';
	takttime = '<spring:message code="KV0.WKV04240.Label.TaktTime"></spring:message>';
	efficiency = '<spring:message code="KV0.WKV04240.Label.Efficiency"></spring:message>';
	dailyovertime = '<spring:message code="KV0.WKV04240.Label.DailyOvertime"></spring:message>';
	holidayovertime = '<spring:message code="KV0.WKV04240.Label.HolidayOvertime"></spring:message>';
	specialeffort = '<spring:message code="KV0.WKV04240.Label.SpecialEffort"></spring:message>';
...
<views:script src="fis/WKV04240.js?t=${currentTimestamp}" />
<div id="screen-panel" style="height: 800px; padding-top: 4px;">
						...
						<tr>
							<td align="right">
								...
								<label class="label" for="unitPlantSearch">
									<spring:message code="KV0.WKV04240.Label.UnitPlant" />:
								</label>
							</td>
							<td>
							...
							<td align="right">
								...
								<label class="label" for="unitParentLineSearch">
									<spring:message code="KV0.WKV04240.Label.ParentLine" />:
								</label>
							</td>
							<td>
							...
							<td align="right">
								...
								<label class="label" for="getsudoMonthSearch">
									<spring:message code="KV0.WKV04240.Label.GetsudoMonth" />:
								</label>
							</td>
							<td>
						...
						<tr>
							...
							<td align="right">
								...
								<label class="label" for="unitSubLineSearch">
									<spring:message code="KV0.WKV04240.Label.SubLine" />:
								</label>
							</td>
							<td>
							...
							<td align="right">
								...
								<label class="label" for="timingSearch">
									<spring:message code="KV0.WKV04240.Label.Timing" />:
								</label>
							</td>
							<td>
								<select name="timingSearch" id="timingSearch"
									...
									<option value=""><spring:message
											code="KV0.common.combobox.select" /></option>
							...
							<td align="right">
								<div id="search-panel"
									...
									<spring:message code="ST3.WST33060.Label.BtnSearch"
										var="WKV04240Search" />
									<sc2:button functionId="KV0424" screenId="WKV04240"
										buttonId="WKV04240Search" type="button" tabIndex="6"
										value="${WKV04240Search}" style="width:80px;"
										styleClass="button" onClick="clickSearch();" />
									<spring:message code="ST3.WST33060.Label.BtnClear"
										var="WKV04240Clear" />
									<sc2:button functionId="KV0424" screenId="WKV04240"
										buttonId="WKV04240Clear" type="button" tabIndex="7"
										value="${WKV04240Clear}" style="width:80px;"
	...
	<div id="operation-panel" style="padding-top: 5px;">
		<div id="second-operation-panel" style="display: inline; zoom: 1; position: relative; white-space: nowrap; float: left; padding-top: 4px;">
			<spring:message code="ST3.WST33060.Label.BtnEdit" var="WKV04240Edit" />
			<spring:message code="KV0.WKV04240.Label.BtnDownload" var="WKV04240Download" />
			<spring:message code="KV0.WKV04240.Label.BtnBrowse" var="WKV04240Browse" />
			<spring:message code="KV0.WKV04240.Label.BtnUpload" var="WKV04240Upload" />
			<div id="operation-download" style="display: inline; zoom: 1; position: relative; white-space: nowrap; float: left; padding-top: 4px; ">
				<sc2:button functionId="KV0424" screenId="WKV04240"
						buttonId="WKV04240Download" type="button"
						value="${WKV04240Download}" styleClass="button"
			...
			<div id="operation-upload" class="operation-upload">
				<form id="upload-form" name="upload-form" 
						...
						<label class="label" for="WKV04240Browse" style="display:none"><spring:message code="KV0.WKV04240.Label.FileName" /></label>				
							<sc2:button functionId="KV0424" screenId="WKV04240"
								buttonId="WKV04240Browse" type="file" value="${WKV04240Browse}"
								styleClass="button MandatoryField" style="padding-top: 2.0px;width:400px;" />
							<sc2:button functionId="KV0424" screenId="WKV04240"
								buttonId="WKV04240Upload" type="button" value="${WKV04240Upload}"
		...
		<div id="operation-btn" style="display: inline; zoom: 1; position: relative; white-space: nowrap; float: right; padding-top: 4px;">
			<spring:message code="ST3.WST33060.Label.BtnEdit"
				var="WKV04240Edit" />
			<sc2:button functionId="KV0424" screenId="WKV04240"
				buttonId="WKV04240Edit" type="button" value="${WKV04240Edit}"
	...
	<div id="search-criteria-label" class="hide">
		<div style="display: -webkit-flex;display: flex;">
			<div class="criteria-label-item" style="width:10%;text-align: right;"><label class="label"><spring:message code="KV0.WKV04240.Label.UnitPlant"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item" style="width:15%"><label class="label"><span id="resultUnitPlantCriteria">-</span></label></div>
			<div class="criteria-label-item" style="width:10%;text-align: right;"><label class="label"><spring:message code="KV0.WKV04240.Label.ParentLine"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item" style="width:15%"><label class="label"><span id="resultUnitParentLineCriteria">-</span></label></div>
			<div class="criteria-label-item" style="width:10%;text-align: right;"><label class="label"><spring:message code="KV0.WKV04240.Label.GetsudoMonth"/>&nbsp;:&nbsp;</label></div>
		...
		<div style="display: -webkit-flex;display: flex;">
			...
			<div class="criteria-label-item" style="width:10%;text-align: right;"><label class="label"><spring:message code="KV0.WKV04240.Label.SubLine"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item" style="width:15%"><label class="label"><span id="resultUnitSubLineCriteria">-</span></label></div>
			<div class="criteria-label-item" style="width:10%;text-align: right;"><label class="label"><spring:message code="KV0.WKV04240.Label.Timing"/>&nbsp;:&nbsp;</label></div>
	...
	<div id="save-panel" class="hide" style="display: inline; zoom: 1; position: relative; float: right; padding-top: 5px;">
		<spring:message code="STD.WSTD3060.Label.BtnSave"
			var="WKV04240Save" />
		<sc2:button functionId="KV0424" screenId="WKV04240"
			buttonId="WKV04240Save" type="button" value="${WKV04240Save}"
			styleClass="button" style="width:80px;"
			onClick="saveAddEditObject();" />
		<spring:message code="ST3.WST33060.Label.BtnCancel"
			var="WKV04240Cancel" />
		<sc2:button functionId="KV0424" screenId="WKV04240"
			buttonId="WKV04240Cancel" type="button" value="${WKV04240Cancel}"

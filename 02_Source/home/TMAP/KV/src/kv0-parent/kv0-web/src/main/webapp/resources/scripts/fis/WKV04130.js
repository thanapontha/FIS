	...
	window.cancelAddEditObject =
		...
		window.popupSubsreen =
			function popupSubsreen(){
				...
				FISLib.dialog.open("subScreenUnitModelAndUnitPlantDialog", _rootPath + "/master/subScreenUnitModelAndUnitPlant?vehiclePlant="+vehiclePlant+"&vehicleModel="+vehicleModel, "WKV04131 : Sub screen Unit Model - Unit Plant" , 805, 480);
		};
		
		window.__callbackData =
			function __callbackData() {
				var emp = FISLib.dialog.$output;
...
//		alert("HaveData : "+haveData +"  lastAction : "+lastAction);
		if(lastAction=='add' || lastAction=='edit'){
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Search', true);
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Clear', true);
			
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Add', true);
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Edit', true);
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Delete', true);
		}else{
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Search', false);
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Clear', false);
			
			ST3Lib.validate.disabledButtonSpecify('#WKV04130Add', false);
			if(haveData){
				ST3Lib.validate.disabledButtonSpecify('#WKV04130Edit', false);
				ST3Lib.validate.disabledButtonSpecify('#WKV04130Delete', false);
			}else{
				ST3Lib.validate.disabledButtonSpecify('#WKV04130Edit', true);
				ST3Lib.validate.disabledButtonSpecify('#WKV04130Delete', true);
			}

...
<views:style src="fis/WKV04120.css"/>
<script>
...
<views:script src="fis/WKV04120.js?t=${currentTimestamp}"/>
				...
				<tr>
					<td align="right">
						...
						<label class="label" for="unitPlantSearch">
							<spring:message code="KV0.WKV04120.Label.UnitPlant"/>:
						</label>
					</td>
					<td>
					...
					<td>
						<label class="label" for="includeExpiredData"><spring:message code="KV0.WKV04120.Label.IncludeExpireData"/></label>
					</td>					
					<td align="right">
						<div id="search-panel" style="display:inline;zoom:1;position:relative;">
							<spring:message code="ST3.WST33060.Label.BtnSearch" var="WKV04120Search" />
							<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Search" 
								type="button" value="${WKV04120Search}"  style="width:80px;"
								styleClass="button" onClick="clickSearch();"
							/>
							<spring:message code="ST3.WST33060.Label.BtnClear" var="WKV04120Clear" />
							<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Clear"
								type="button" value="${WKV04120Clear}"  style="width:80px;"
	...
	<table style="width: 100%; border: 0;">
		<tr><td>
			<div id="operation-panel" style="display:inline;zoom:1;position:relative;white-space: nowrap;float: right;padding-top: 4px;">
				<spring:message code="ST3.WST33060.Label.BtnAdd" var="WKV04120Add" />
				<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Add"
					type="button" value="${WKV04120Add}" 
					styleClass="button"
					style="width:80px;"
					onClick="addObject();"
					/>
				<spring:message code="ST3.WST33060.Label.BtnEdit" var="WKV04120Edit" />
				<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Edit" 
					type="button" value="${WKV04120Edit}" 
					styleClass="button"
					style="width:80px;"
					onClick="editObject();"
					/>
				<spring:message code="ST3.WST33060.Label.BtnDelete" var="WKV04120Delete" />
				<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Delete" 
					type="button" value="${WKV04120Delete}" 
					styleClass="button"
					style="width:80px;"
				...
				<div id="search-result" class="overflow-hidden" style="height: 330px;">
							<div id="dataList" class="container" style="height: 310px; width:100%;border: none;" >
								<form id="result-list-form" 
								    ...
								    <spring:message code="KV0.WKV04120.Label.No" var="ColNo"/>
									<spring:message code="KV0.WKV04120.Label.UnitModel" var="ColUnitModel"/>
									<spring:message code="KV0.WKV04120.Label.UnitParentLine" var="ColUnitParentLine"/>
									<spring:message code="KV0.WKV04120.Label.UnitSubLine" var="ColUnitSubLine"/>
									<spring:message code="KV0.WKV04120.Label.Type" var="ColType"/>
									<spring:message code="KV0.WKV04120.Label.TCFrom" var="ColTCFrom"/>
									<spring:message code="KV0.WKV04120.Label.TCTo" var="ColTCTo"/>
									<spring:message code="KV0.WKV04120.Label.Remark" var="ColRemark"/>
									<spring:message code="KV0.common.label.UpdateBy" var="ColUpdateBy"/>
									<spring:message code="KV0.common.label.UpdateDate" var="ColUpdateDate"/>
		...
		<tr><td>
			<div id="save-panel" class="hide" style="display:inline;zoom:1;position:relative;float: right;">
				<spring:message code="STD.WSTD3060.Label.BtnSave" var="WKV04120Save" />
				<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Save" 
					type="button" value="${WKV04120Save}" 
					styleClass="button"
					style="width:80px;"
					onClick="saveAddEditObject();"
					/>
				<spring:message code="ST3.WST33060.Label.BtnCancel" var="WKV04120Cancel" />
				<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Cancel" 
					type="button" value="${WKV04120Cancel}" 

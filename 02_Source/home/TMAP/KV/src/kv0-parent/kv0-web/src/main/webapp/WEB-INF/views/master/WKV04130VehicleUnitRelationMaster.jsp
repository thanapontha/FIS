...
<views:style src="fis/WKV04130.css"/>
<script>
...
<views:script src="fis/WKV04130.js?t=${currentTimestamp}"/>
				...
				<tr>
					<td align="right">
						...
						<label class="label" for="vehiclePlantSearch">
							<spring:message code="KV0.WKV04130.Label.VehiclePlant"/>:
						</label>
					</td>
					<td>
					...
					<td align="right">
						...
						<label class="label" for="vehicleModelSearch">
							<spring:message code="KV0.WKV04130.Label.VehicleModel"/>:
						</label>
					</td>
					<td>
					...
					<td>
						<label class="label" for="includeExpiredData"><spring:message code="KV0.WKV04130.Label.IncludeExpiredData"/></label>
					</td>					
					<td align="right">
						<div id="search-panel" style="display:inline;zoom:1;position:relative;">
							<spring:message code="ST3.WST33060.Label.BtnSearch" var="WKV04130Search" />
							<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Search" 
								type="button" value="${WKV04130Search}"  style="width:80px;"
								styleClass="button" onClick="clickSearch();"
							/>
							<spring:message code="ST3.WST33060.Label.BtnClear" var="WKV04130Clear" />
							<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Clear"
								type="button" value="${WKV04130Clear}"  style="width:80px;"
	...
	<table style="width: 100%; border: 0;">
		<tr><td>
			<div id="operation-panel" style="display:inline;zoom:1;position:relative;white-space: nowrap;float: right;padding-top: 4px;">
				<spring:message code="ST3.WST33060.Label.BtnAdd" var="WKV04130Add" />
				<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Add"
					type="button" value="${WKV04130Add}" 
					styleClass="button"
					style="width:80px;"
					onClick="addObject();"
					/>
				<spring:message code="ST3.WST33060.Label.BtnEdit" var="WKV04130Edit" />
				<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Edit" 
					type="button" value="${WKV04130Edit}" 
					styleClass="button"
					style="width:80px;"
					onClick="editObject();"
					/>
				<spring:message code="ST3.WST33060.Label.BtnDelete" var="WKV04130Delete" />
				<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Delete" 
					type="button" value="${WKV04130Delete}" 
					styleClass="button"
					style="width:80px;"
				...
				<div id="search-result" class="overflow-hidden" style="height: 330px;">
							<div id="dataList" class="container" style="height: 310px; width:100%;border: none;" >
								<form id="result-list-form" 
								    ...
								    <spring:message code="KV0.WKV04130.Label.No" var="ColNo"/>
									<spring:message code="KV0.WKV04130.Label.UnitModel" var="ColUnitModel"/>
									<spring:message code="KV0.WKV04130.Label.UnitType" var="ColUnitType"/>
									<spring:message code="KV0.WKV04130.Label.Priority" var="ColPriority"/>
									<spring:message code="KV0.WKV04130.Label.UnitPlant" var="ColUnitPlant"/>
									<spring:message code="KV0.WKV04130.Label.TCFrom" var="ColTCFrom"/>
									<spring:message code="KV0.WKV04130.Label.TCTo" var="ColTCTo"/>
		...
		<tr><td>
			<div id="save-panel" class="hide" style="display:inline;zoom:1;position:relative;float: right;">
				<spring:message code="STD.WSTD3060.Label.BtnSave" var="WKV04130Save" />
				<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Save" 
					type="button" value="${WKV04130Save}" 
					styleClass="button"
					style="width:80px;"
					onClick="saveAddEditObject();"
					/>
				<spring:message code="ST3.WST33060.Label.BtnCancel" var="WKV04130Cancel" />
				<sc2:button functionId="KV0413"  screenId="WKV04130" buttonId="WKV04130Cancel" 
					type="button" value="${WKV04130Cancel}" 

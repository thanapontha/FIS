...
@ComponentScan({ "th.co.toyota.application.web",
		...
		"th.co.toyota.kv0.api.common.upload",
		"th.co.toyota.kv0.api.repository.common",//refer to api model
		"th.co.toyota.kv0.api.service.common",//refer to api model
		"th.co.toyota.kv0.batch.report",
		"th.co.toyota.kv0.batch.repository",
		"th.co.toyota.kv0.batch.preprocess.repository",
		"th.co.toyota.kv0.api.common",
		"th.co.toyota.kv0.common.repository",
		"th.co.toyota.kv0.common.service",
		"th.co.toyota.kv0.web.common",
		"th.co.toyota.kv0.web.report",
		"th.co.toyota.kv0.web",
		"th.co.toyota.kv0.util"})

...
<views:style src="tim/WKV04210.css"/>
...
<views:script src="tim/WKV04210.js?t=${currentTimestamp}"/>
	...
	<div id="screen-panel" class="container-fluid">
		...
		<div class="row pt-1 pb-5">
			<div class="py-1 col-12" style="text-align: right;">
            	<sc2:button functionId="KV0421"  screenId="WKV04210" buttonId="WKV04210Save" type="button" value="Save"
					styleClass="button" secured="false" onClick="saveAddEditObject();"/>
				<sc2:button functionId="KV0421"  screenId="WKV04210" buttonId="WKV04210Cancel" type="button" value="Cancel"

(function($){
	...
	window.doDownload =
			            ...
			            success: function(data) {
			            	if(data  && typeof data != 'undefined'){	
				        		...
				        		if(objSerialize.errorMessages != "" && typeof objSerialize.errorMessages != 'undefined') {
					            	...
					            	$('#WKV04210Upload').removeAttr('disabled');
					            	loadingUpload.close();
					            	loadingUpload = null;
					            	disableButtonOfBodySection(false);
					            	checkConfirmMessageBeforeExit = false;
		...
		function disableButtonOfBodySection(disableFlag){
			ST3Lib.validate.disabledButtonSpecify( '#WKV04210Download', disableFlag );
			ST3Lib.validate.disabledButtonSpecify( '#WKV04210Upload', disableFlag );
			ST3Lib.validate.disabledButtonSpecify( '#WKV04210Browse', disableFlag );
		}

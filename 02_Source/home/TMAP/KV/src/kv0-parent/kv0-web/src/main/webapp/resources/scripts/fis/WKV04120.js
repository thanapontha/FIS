...
//				FISLib.clearST3Message();
	...
	function enableDisableButton(haveData){
		...
		if(lastAction=='add' || lastAction=='edit'){
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Search', true);
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Clear', true);
			
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Add', true);
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Edit', true);
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Delete', true);
		}else{
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Search', false);
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Clear', false);
			
			ST3Lib.validate.disabledButtonSpecify('#WKV04120Add', false);
			if(haveData){
				ST3Lib.validate.disabledButtonSpecify('#WKV04120Edit', false);
				ST3Lib.validate.disabledButtonSpecify('#WKV04120Delete', false);
			}else{
				ST3Lib.validate.disabledButtonSpecify('#WKV04120Edit', true);
				ST3Lib.validate.disabledButtonSpecify('#WKV04120Delete', true);
			}

...
<views:style src="tim/WKV06530.css"/>
<script>
...
<views:script src="tim/WKV06530.js?t=${currentTimestamp}"/>
		               ...
		               <h3>Screening Criteria</h3>
		        		...
		        		<div class="row mt-1">
		                   ...
		                   <div class="pb-1 pr-3 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="text-align: right;">
		                       <sc2:button functionId="KV0651"  screenId="WKV06510" buttonId="WKV06510Search"

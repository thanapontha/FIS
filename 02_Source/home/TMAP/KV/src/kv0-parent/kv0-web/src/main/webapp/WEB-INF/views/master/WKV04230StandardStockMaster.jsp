...
<%@page import="th.co.toyota.kv0.api.constants.AppConstants"%>
 ...
 <views:style src="fis/WKV04230.css" />
 <script>
...
<fmt:formatDate pattern = "yyyyMMddmmss"  value="${now}" var="currentTimestamp" />
 ...
 <views:script src="fis/WKV04230.js?t=${currentTimestamp}" />
 ...
 <div id="screen-panel" style="height: 800px; padding-top: 4px;">
 				...
 				<tr>
 					<td align="right">
 						...
 						<label class="label" for="getsudoMonthSearch">
							<spring:message code="KV0.WKV04230.Label.GetsudoMonth" />:
 						</label>
 					</td>
 					<td>
 					...
 					<td align="right">
 						...
 						<label class="label" for="vehiclePlantSearch">
							<spring:message code="KV0.WKV04230.Label.VehiclePlant" />:
 						</label>
 					</td>
 					<td>
 					...
 					<td align="right">
 						...
 						<label class="label" for="unitModelSearch">
							<spring:message code="KV0.WKV04230.Label.UnitModel" />:
 						</label>
 					</td>
 					<td>
 				...
 				<tr>
 					<td align="right">
 						...
 						<label class="label" for="timingSearch">
							<spring:message code="KV0.WKV04230.Label.Timing" />:
 						</label>
 					</td>
 					<td>
 					...
 					<td align="right">
						...
						<label class="label" for="unitPlantSearch">
							<spring:message code="KV0.WKV04230.Label.UnitPlant" />:
						</label>
 					</td>
 					<td>
 				...
 				<tr>
 					...
 					<td align="right">
						...
						<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Search" 
							type="button" value="${WKV04120Search}"  style="width:80px;" tabIndex="7"
						...
						<sc2:button functionId="KV0412"  screenId="WKV04120" buttonId="WKV04120Clear"
							type="button" value="${WKV04120Clear}"  style="width:80px;" tabIndex="8"
			...
			<td>
				...
				<div id="operation-btn" style="display: inline; zoom: 1; position: relative; white-space: nowrap; float: right; padding-top: 4px;">
					<spring:message code="ST3.WST33060.Label.BtnEdit"
						var="WKV04230Edit" />
					<sc2:button functionId="KV0423" screenId="WKV04230"
						buttonId="WKV04230Edit" type="button" value="${WKV04230Edit}"
	...
	<div id="search-criteria-label"  class="hide">
		 <div style="display: -webkit-flex;display: flex;">
			<div class="criteria-label-item" style="text-align: right;"><label class="label"><spring:message code="KV0.WKV04230.Label.GetsudoMonth"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item"><label class="label"><span id="resultGetsudoMonthSearch">-</span></label></div>
			<div class="criteria-label-item" style="text-align: right;"><label class="label"><spring:message code="KV0.WKV04230.Label.VehiclePlant"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item"><label class="label"><span id="resultVehiclePlantSearch">-</span></label></div>
			<div class="criteria-label-item" style="text-align: right;"><label class="label"><spring:message code="KV0.WKV04230.Label.UnitModel"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item"><label class="label"><span id="resultUnitModelSearch">-</span></label></div>
		</div>
		<div style="display: -webkit-flex;display: flex;">
			<div class="criteria-label-item" style="text-align: right;"><label class="label"><spring:message code="KV0.WKV04230.Label.Timing"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item"><label class="label"><span id="resultTimingSearch">-</span></label></div><br/>
			<div class="criteria-label-item" style="text-align: right;"><label class="label"><spring:message code="KV0.WKV04230.Label.VehicleModel"/>&nbsp;:&nbsp;</label></div>
			<div class="criteria-label-item"><label class="label"><span id="resultVehicleModelSearch">-</span></label></div>
			<div class="criteria-label-item" style="text-align: right;"><label class="label"><spring:message code="KV0.WKV04230.Label.UnitPlant"/>&nbsp;:&nbsp;</label></div>
	...
	<div id="save-panel" class="hide"
		...
		<spring:message code="STD.WSTD3060.Label.BtnSave"
			var="WKV04230Save" />
		<sc2:button functionId="KV0423" screenId="WKV04230"
			buttonId="WKV04230Save" type="button" value="${WKV04230Save}"
			styleClass="button" style="width:80px;"
			onClick="saveAddEditObject();" />
		<spring:message code="ST3.WST33060.Label.BtnCancel"
			var="WKV04230Cancel" />
		<sc2:button functionId="KV0423" screenId="WKV04230"
			buttonId="WKV04230Cancel" type="button" value="${WKV04230Cancel}"

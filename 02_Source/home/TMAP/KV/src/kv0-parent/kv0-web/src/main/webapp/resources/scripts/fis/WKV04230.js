(function($){
	...
	window.searchFinish =
		...
		function enableDisableButton(haveData){					
			if(lastAction=='edit'){
				ST3Lib.validate.disabledButtonSpecify('#WKV04230Search', true);
				ST3Lib.validate.disabledButtonSpecify('#WKV04230Clear', true);
				
				ST3Lib.validate.disabledButtonSpecify('#WKV04230Edit', true);
			}else{
				ST3Lib.validate.disabledButtonSpecify('#WKV04230Search', false);
				ST3Lib.validate.disabledButtonSpecify('#WKV04230Clear', false);
				
				if(haveData){
					ST3Lib.validate.disabledButtonSpecify('#WKV04230Edit', false);
				}else{
					ST3Lib.validate.disabledButtonSpecify('#WKV04230Edit', true);
				}
			}

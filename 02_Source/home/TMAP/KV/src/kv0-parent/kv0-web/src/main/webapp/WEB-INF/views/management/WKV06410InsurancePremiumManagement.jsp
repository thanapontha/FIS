							     	...
							     	<div class="card-body">
							        	<div class="row"> 
				        					...
				        					<div class="col-12 d-flex justify-content-end">
				        						<sc2:button functionId="KV0641"  screenId="WKV06410" buttonId="WKV06410Download1"
									...
									<div class="card-header text-white bg-success">Transfer Premium (both Toyota & Non Toyota Bands)</div>
							     	<div class="card-body">
							        	<div class="row"> 
				        					...
				        					<div class="col-12 d-flex justify-content-end">
				        						<sc2:button functionId="KV0641"  screenId="WKV06410" buttonId="WKV06410Download2"
													type="button" value="PDF Export & Printing" styleClass="button" secured="false" onClick=""/>
				        					</div>
				        				</div>
							      	</div>
       	...
       	<div class="row pb-5"> 
    		<div class="col-12">
				<div class="d-flex flex-row col-12 justify-content-end py-0">
	                ...
	                <div>
	                  	<sc2:button functionId="KV0641"  screenId="WKV06410" buttonId="WKV06410Search"

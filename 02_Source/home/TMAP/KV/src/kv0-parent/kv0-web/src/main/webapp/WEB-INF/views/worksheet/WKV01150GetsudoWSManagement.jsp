...
<views:style src="fis/WKV01150.css" />
<script>
	...
	MKV00004ACFM_Complete = '<spring:message code="MKV00004ACFM" arguments="complete data"></spring:message>';
	MKV00004ACFM_Reset = '<spring:message code="MKV00004ACFM" arguments="reset data to Kaikieng data input by TMAP-MS"></spring:message>';
	MKV00005ACFM_Upload = '<spring:message code="MKV00005ACFM" arguments="The Worksheet was already uploaded on {Date_Time}|re-upload the Worksheet" argumentSeparator="|"></spring:message>';
	MKV00006ACFM_CompleteReset = '<spring:message code="MKV00006ACFM" arguments="Data already completed in this Getsudo Month.|reset data to Kaikieng data input by TMAP-MS" argumentSeparator="|"></spring:message>';
...
<views:script src="fis/WKV01150.js?t=${currentTimestamp}" />
<div id="screen-panel" style="height: 800px; padding-top: 4px;">
						...
						<tr>
							<td align="right">
								...
								<label class="label" for="getsudoMonthSearch">
									<spring:message code="KV0.WKV01150.Label.GetsudoMonth" />:
								</label>
							</td>
							<td>
							...
							<td align="right">
								...
								<label class="label" for="timingSearch">
									<spring:message code="KV0.WKV01150.Label.Timing" />:
								</label>
							</td>
							<td>
							...
							<td align="right">
								...
								<label class="label" for="vehiclePlantSearch">
									<spring:message code="KV0.WKV01150.Label.VehiclePlant" />:
								</label>
							</td>
							<td>
							...
							<td colspan="6" align="right">
								<div id="search-panel"
									...
									<spring:message code="ST3.WST33060.Label.BtnSearch"
										var="WKV01150Search" />
									<sc2:button functionId="KV0115" screenId="WKV01150"
										buttonId="WKV01150Search" type="button" tabIndex="4"
										value="${WKV01150Search}" style="width:80px;"
										styleClass="button" onClick="clickSearch();" />
									<spring:message code="ST3.WST33060.Label.BtnClear"
										var="WKV01150Clear" />
									<sc2:button functionId="KV0115" screenId="WKV01150"
										buttonId="WKV01150Clear" type="button" tabIndex="5"
										value="${WKV01150Clear}" style="width:80px;"
	...
	<div id="operation-panel" style="padding-top: 5px;">
		<div id="operation-download" style="display: inline; zoom: 1; position: relative; white-space: nowrap; float: left; padding-top: 4px;">
			<spring:message code="KV0.WKV01150.Label.BtnDownload" var="WKV01150Download" />
			<sc2:button functionId="KV0115" screenId="WKV01150"
							buttonId="WKV01150Download" type="button"
							value="${WKV01150Download}" styleClass="button"
							style="width:80px;" onClick="doDownload();" />
		</div>
		<div id="operation-upload" class="operation-upload">
			<spring:message code="KV0.WKV01150.Label.BtnBrowse" var="WKV01150Browse" />
			<spring:message code="KV0.WKV01150.Label.BtnUpload" var="WKV01150Upload" />
			<spring:message code="KV0.WKV01150.Label.BtnLog" var="WKV01150Log" />
			<form id="upload-form" name="upload-form" 
				...
				<div style="margin-top:0px;">					
					<label class="label" for="WKV01150Browse" style="display:none"><spring:message code="KV0.WKV01150.Label.FileName" /></label>
					<sc2:button functionId="KV0115" screenId="WKV01150"
						buttonId="WKV01150Browse" type="file" value="${WKV01150Browse}"
						styleClass="button MandatoryField" style="padding-top: 2.0px;width:400px;"
						onClick="" />
					<sc2:button functionId="KV0115" screenId="WKV01150"
						buttonId="WKV01150Upload" type="button" value="${WKV01150Upload}"
						styleClass="button" style="width:80px;" onClick="doUpload();" />
					<sc2:button functionId="KV0115" screenId="WKV01150"
						buttonId="WKV01150Log" type="button" value="${WKV01150Log}"
		...
		<div id="operation-btn" style="display: inline; zoom: 1; position: relative; white-space: nowrap; float: right; padding-top: 4px;">
			<spring:message code="KV0.WKV01150.Label.BtnComplete" var="WKV01150Complete" />
			<spring:message code="KV0.WKV01150.Label.BtnReset" var="WKV01150Reset" />
			<spring:message code="KV0.WKV01150.Label.BtnCompletedReset" var="WKV01150CompletedReset" />

			<sc2:button functionId="KV0115" screenId="WKV01150"
				buttonId="WKV01150Complete" type="button" value="${WKV01150Complete}"
				styleClass="button" style="width:80px;" onClick="doComplete();" />
			<sc2:button functionId="KV0115" screenId="WKV01150"
				buttonId="WKV01150Reset" type="button" value="${WKV01150Reset}"
				styleClass="button" style="width:80px;" onClick="doReset();" />
			<sc2:button functionId="KV0115" screenId="WKV01150"
				buttonId="WKV01150CompletedReset" type="button" value="${WKV01150CompletedReset}"
	...
	<div id="search-criteria-label" style="display: -webkit-flex;" class="">
		<div class="criteria-label-item"><label class="label"><spring:message code="KV0.WKV01150.Label.GetsudoMonth"/> : <span id="getsudoMonthCriteria">-</span></label></div>
		<div class="criteria-label-item"><label class="label"><spring:message code="KV0.WKV01150.Label.Timing"/> : <span id="timingCriteria">-</span></label></div>
		<div class="criteria-label-item"><label class="label"><spring:message code="KV0.WKV01150.Label.VehiclePlant"/> : <span id="vehiclePlantCriteria">-</span></label></div>
	</div>
			...
			<div id="search-result" class="" style="height: 360px;">
				<div id="dataList" class="container" style="overflow:auto;height: 360px;border: none;" >
					<form id="result-list-form" 
				   		...
				   		<spring:message code="KV0.WKV01150.Label.No" var="ColNo"/>
						<spring:message code="KV0.WKV01150.Label.VehicleModel" var="ColVehicleModel"/>
						<spring:message code="KV0.WKV01150.Label.Status" var="ColStatus"/>
						<spring:message code="KV0.WKV01150.Label.UpdateBy" var="ColUpdateBy"/>
						<spring:message code="KV0.WKV01150.Label.UpdateDate" var="ColUpdateDate"/>
						<spring:message code="KV0.WKV01150.Label.CompleteStatus" var="ColCompleteStatus"/>	

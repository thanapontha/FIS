	 ...
	 <DIV class="wsmobileheader clearfix "><A class="wsanimated-arrow" id="wsnavtoggle"><SPAN></SPAN></A> 
		<div class="row">
			<div class="col-12 application-panel">
				<span class="application">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<spring:message code="KV0.lbl.Application"/></span> 
	                     ...
	                     <DIV class="col-lg-6 col-md-12 col-xs-12">
	                        ...
	                        <DIV >
	                        	<A href="${pageContext.request.contextPath}/Kaikieng/kaikiengInput">
	                        		<input tabindex="1" id="KV0100" type="image" src="${pageContext.request.contextPath}<spring:message code="imagepath"/>images/tim/New_Car_Insurance_Portfolio_Management.png" title="New Car Insurance Portfolio Management"/>
	                        	</A>
	                        </DIV>
	                     </DIV>
	                     <DIV class="col-lg-6 col-md-12 col-xs-12">
	                        ...
	                        <DIV>
	                        	<A href="${pageContext.request.contextPath}/master/vehiclePlant">
	                        		<input tabindex="1" id="KV0100" type="image" src="${pageContext.request.contextPath}<spring:message code="imagepath"/>images/tim/New_Car_Insurance.png" title="New Car Insurance Activation Management"/>
	                        	</A>
	                        </DIV>
	                     </DIV>
	                  </DIV>
	                  ...
	                  <DIV class="row">
	                     <DIV class="col-lg-4 col-md-12 col-xs-12">
	                        ...
	                        <DIV class="fluid-width-video-wrapper">
	                        	<A href="${_mappingPath}">
	                        		<input tabindex="1" id="KV0100" type="image" src="${pageContext.request.contextPath}<spring:message code="imagepath"/>images/tim/Standard_Renewal_SOP_PIC_Setting.png" title="Standard Renewal SOP & PIC Setting"/>
	                        	</A>
	                        </DIV>
	                     </DIV>
	                     <DIV class="col-lg-4 col-md-12 col-xs-12">
	                        ...
	                        <DIV class="fluid-width-video-wrapper">
	                        	<A href="${_mappingPath}">
	                        		<input tabindex="1" id="KV0100" type="image" src="${pageContext.request.contextPath}<spring:message code="imagepath"/>images/tim/Special_Contact_Setting.png" title="Special Contact Setting"/>
	                        	</A>
	                        </DIV>
	                     </DIV>
	                     <DIV class="col-lg-4 col-md-12 col-xs-12">
	                        ...
	                        <DIV class="fluid-width-video-wrapper">
	                        <A href="${_mappingPath}">
	                        		<input tabindex="1" id="KV0100" type="image" src="${pageContext.request.contextPath}<spring:message code="imagepath"/>images/tim/Activities_Reminder.png" title="Activities Reminder"/>
	                        </A> </DIV>
	                     </DIV>
	                  </DIV>
	               </DIV>
